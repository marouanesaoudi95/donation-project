...
const PostCard = ({ post, showActions, onEdit, onDelete }) => {
  ...
  const icon        = TYPE_ICON[post.donationType] || TYPE_ICON.other
      ...
      <div style={{ padding: '1.25rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem', marginBottom: '0.875rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flex: 1, minWidth: 0 }}>
            <span style={{ color: '#f97316', flexShrink: 0 }}>{icon}</span>
            <div style={{ minWidth: 0 }}>
              <h3 style={{
                fontWeight: 700, color: '#1c1917', textTransform: 'capitalize',
                fontSize: '1rem', whiteSpace: 'nowrap', overflow: 'hidden',
                textOverflow: 'ellipsis', fontFamily: 'Playfair Display,serif',
              }}>
                {post.donationType}
              </h3>
        ...
        {/* Description */}
        <p style={{ fontSize: '0.875rem', color: '#78716c', lineHeight: 1.6, marginBottom: '1rem' }}>
        ...
        {post.donor && (
          <div style={{
            ...
            padding: '0.625rem', background: '#fafaf9', borderRadius: '0.75rem', marginBottom: '1rem',
          }}>
            <div style={{
              width: '1.75rem', height: '1.75rem', borderRadius: '50%',
              background: '#ffedd5', display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: '#ea6c10', flexShrink: 0,
            }}>
              <User size={14} />
            </div>
            <div>
          ...
          <motion.div style={{ flex: 1 }} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link
              ...
              style={{
                ...
                padding: '0.625rem', background: '#fff7ed', color: '#ea6c10',
            ...
            <>
              <motion.button
                ...
                style={{
                  ...
                  background: '#f5f5f4', borderRadius: '0.75rem',
              ...
              <motion.button
                ...
                style={{
                  padding: '0.5rem 0.75rem', border: 'none',
                  background: '#fef2f2', borderRadius: '0.75rem',
                  cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: '#dc2626',
                }}
              >
